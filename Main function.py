...
#Import in data
games = pd.read_csv(r'C:\Users\njfur\Desktop\Kaggle\nfl-big-data-bowl-2021\games.csv')
players =pd.read_csv(r'C:\Users\njfur\Desktop\Kaggle\nfl-big-data-bowl-2021\players.csv')
plays =pd.read_csv(r'C:\Users\njfur\Desktop\Kaggle\nfl-big-data-bowl-2021\plays.csv')
...
for csv in dfs:
    ...
    str_name = r'C:\Users\njfur\Desktop\Modified_Datasets\week' + str(number)+ '_plays.csv'
